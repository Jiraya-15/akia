	    ...
	    case 'اسم': {
            ...
            case 'swm': case 'take': case 'stickerwm': {
             ...
             case 'حقيقة':
              ...
              GojoMdNx.sendMessage(from, { image: buffer, caption: '_You choose DARE_\n'+ xeondare }, {quoted:m})
              break
                            break
       case 'سؤال':
              const truth =[
              ...
              buffer = await getBuffer(`https://i.ibb.co/bvQqvhJ/th-5.jpg`)
              GojoMdNx.sendMessage(from, { image: buffer, caption: '_You choose TRUTH_\n'+ xeontruth }, {quoted:m})
              break
