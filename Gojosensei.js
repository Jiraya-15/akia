...
「 معلومات 」
📕 كت
📗 يرسل البوت اسماء شخصيات وانت تعيد كتابتها.
📙 كت = كلمة     كتت = كلمتين     كتتت = 3 كلمات

📕مق
📗يرسل البوت مقولات وعبارات قالتها شخصيات فالانمي.

📕حرف
📗يرسل البوت حرف اذا كان مكتوب اول حرف لازم تجيب اسم يبدا بذاك الحرف واذا كان مكتوب اخر حرف لازم تجيب اسم ينتهي بذاك الحرف.

📕س
📗يرسل البوت سؤال خاص بانمي.

📕حقيقة
📗يرسل البوت بعض الاسئلة واجب بصراحة.

📕 ابطال
📗 يرسل البوت اسم انمي ، وانت تكتب بطل الانمي.
📙 مثال : البوت يرسل ◈ ون بيس ◈ وانت تكتب لوفي.

📕تر
📗  البوت يرسل اسم انمي  من حروف غير مرتبة ، وانت لازم ترتبها. 
📙مثال : ي ا ا ر ي ج   الجواب : جيرايا
────────────────┈ ⳹
✑  اذا هناك اخطاء فالبوت كلم المطور
────────────────┈ ⳹`,
 hydratedButtons: [{
